...
describe('UserController', () => {
    ...
    describe('sign-up', () => {
        it('should return error for invalid email format', async () => {
            const req = {
                body: { email: 'invalid-email', password: 'password@1234', nickname: 'TestUser' },
            } as Request;
        ...
        it('should return error for invalid password format', async () => {
            const req = { body: { email: 'test@example.com', password: 'short', nickname: 'TestUser' } } as Request;
            const res = { status: jest.fn().mockReturnThis(), json: jest.fn() } as unknown as Response;
        ...
        it('should return error for already used email', async () => {
            const req = {
                body: { email: 'test@example.com', password: 'password@1234', nickname: 'TestUser' },
            } as Request;
            const res = { status: jest.fn().mockReturnThis(), json: jest.fn() } as unknown as Response;
    ...
    describe('signIn', () => {
        ...
        it('should return error for invalid email format', async () => {
            const req = { body: { email: 'invalid-email', password: 'password@1234' } } as Request;
            const res = { status: jest.fn().mockReturnThis(), json: jest.fn() } as unknown as Response;
        ...
        it('should return error for non-existing user', async () => {
            const req = { body: { email: 'nonexistent@example.com', password: 'password@1234' } } as Request;
            const res = { status: jest.fn().mockReturnThis(), json: jest.fn() } as unknown as Response;
        ...
        it('should return error if email is not verified', async () => {
            const req = { body: { email: 'test@example.com', password: 'password@1234' } } as Request;
            const res = { status: jest.fn().mockReturnThis(), json: jest.fn() } as unknown as Response;
