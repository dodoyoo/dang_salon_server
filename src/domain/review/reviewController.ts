...
export class ReviewController {
    ...
    public async createReviews(req: Request, res: Response) {
        ...
        try {
            ...
            const reviewImageListData: Partial<ReviewImage>[] = images?.map((image) => ({
            ...
            const review = await this.reviewRepository.createReview(reviewData, queryRunner);
            const reviewImages = await this.reviewImageRepository.createReviewImages(reviewImageListData, queryRunner);
    ...
    public async updateReview(req: Request, res: Response) {
        try {
            ...
            const updatedReview = await this.reviewRepository.updateReview(parseInt(reviewId, 10), user_id, content);
    ...
    public async deleteReview(req: Request, res: Response) {
        try {
            ...
            const deletedReview = await this.reviewRepository.deleteReview(parseInt(reviewId, 10), user_id);
