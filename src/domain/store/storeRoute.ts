...
const storeImageRepository = new StoreImageRepository();
const storeTimSlotRepository = new StoreTimeSlotRepository();
const storeController = new StoreController(
    storeRepository,
    userRepository,
    storeImageRepository,
    storeTimSlotRepository,
);
...
router.post('/api/stores', authMiddleware, upload.array('images'), (req, res) => storeController.createStore(req, res));
/**
 * @swagger
 * /api/stores:
 *   post:
