...
var dataSource_1 = require('../src/models/dataSource');
                    ...
                    return [
                        ...
                        dataSource_1.AppDataSource.initialize()
                                ...
                                app.listen(port, function () {
                                    return __awaiter(void 0, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            ...
                                            console.log(
                                                'Swagger docs available at http://localhost:'.concat(port, '/api-docs'),
                                            );
                                            return [2 /*return*/];
                                        });
                                    });
                            ...
                            .catch(function (error) {
                                return console.error('Error during Data Source initialization:', error);
                            }),
                    ];
                case 1:
                    _a.sent();
