...
router.get('/api/users/:userId', jwtAuth_1.authMiddleware, (req, res) => userController.getUserById(req, res));
/**
 * @swagger
 * /api/users/{userId}:
 *   get:
...
// 구글 로그인 리디렉션 처리
router.get('/login/redirect', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const tokens = tokenResponse.data; // 토큰 정보 가져오기
...
router.get('/email-verification', (req, res) => {
    res.sendFile(path_1.default.join(__dirname, '..', 'user', 'emailcheck.html'));
});
