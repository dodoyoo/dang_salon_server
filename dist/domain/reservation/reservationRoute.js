...
router.post('/api/reservations', (req, res) => reservationController.createReservations(req, res));
/**
 * @swagger
 *  /api/reservations:
 *    post:
 ...
 */
// 예약 취소 & Swagger
router.delete('/api/reservations/:reservationId', (req, res) => reservationController.deleteReservations(req, res));
/**
 * @swagger
 ...
 *                    example: "서버 오류입니다."
 */
router.get('/api/stores/:storeId/reservations', (req, res) => reservationController.getReservations(req, res));
/**
 * @swagger
